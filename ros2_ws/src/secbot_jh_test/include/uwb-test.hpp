...
class UWB_Tag_Sim:public rclcpp::Node{
    ...
    rclcpp::Publisher<mcu_msgs::msg::UWBAnchorInfo>::SharedPtr anchor_info_publisher;
    std::string tag_name = "Drone";//if you need to know the names of the tags use gz topic -l
    std::default_random_engine tandomGenerator;
    rclcpp::Publisher<mcu_msgs::msg::UWBRanging>::SharedPtr uwb_ranges_array_publisher;
};
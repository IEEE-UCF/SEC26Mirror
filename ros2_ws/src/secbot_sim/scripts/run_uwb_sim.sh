...
# ---- Build ----
colcon build --packages-select mcu_msgs secbot_msgs my_robot_description secbot_sim secbot_navigation secbot_fusion secbot_vision uwb_interfaces uwb_simulation secbot_uwb
set +u
...
ros2 launch secbot_sim uwb_sim.launch.py &
LAUNCH_PID=$!
